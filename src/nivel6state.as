package  
{
	 ...
	 * @author Matheus
	 */
	public class nivel6state extends FlxState
	{
		[Embed(source = '../assets/Background_nivel3_400x300.png')]private var fundoPNG:Class;
		...
		private var end:Parabens = new Parabens
		...
		override public function update():void
		{
			...
			if (tempo < 0)
			{
				end.seuScore(FlxG.score, numMisseis, numCidades);
				FlxG.switchState(new Parabens);
			}
		...
		{
			naves.add(new Nave(FlxG.random() * 400, 60));
			naves.add(new Nave(FlxG.random() * 400, 60));
			naves.add(new Nave(FlxG.random() * 400, 60));
			//add(naves);
		}
