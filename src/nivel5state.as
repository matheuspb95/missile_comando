package  
{
	 ...
	 * @author Matheus
	 */
	public class nivel5state extends FlxState
	{
		[Embed(source = '../assets/Background_nivel2_400x300.png')]private var fundoPNG:Class;
		...
		override public function update():void
		{
			...
			if (tempo < 0)
			{
				FlxG.switchState(new nivel6state);
			}
		...
		{
			naves.add(new Nave(FlxG.random() * 400, 50));
			naves.add(new Nave(FlxG.random() * 400, 50));
			naves.add(new Nave(FlxG.random() * 400, 50));
			//add(naves);
		}
